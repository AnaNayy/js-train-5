// Завдання 1: Дано масив, використовуючи цикл "for in" виведіть на консоль
//всі індекси цього масиву
...
// Завдання 3: Дано масив, використовуючи цикл "for of" знайдіть добуток
...
// Завдання 4: Дано масив рядків. За допомогою циклу for переберіть масив,
//видаліть третій елемент масиву та перетворіть кожен елемент в рядок
//за допомогою методу toString().Результат виведіть на консоль.
...
// Завдання 6: Функція приймає деструктуризований масив чисел де буду
//перший елемент та масив всіх інших.
// За допомогою циклу for переберіть масив, знайдіть мінімальне та
// максимальне значення.Результат виведіть на консоль.
function findMinMax([firstElement, ...restElements]) {
  // Ініціалізуємо змінні для мінімального та максимального значень, задаємо їм
  // перше значення масиву
...
// Перетворіть масив в рядок за допомогою методу toString() та повторіть
// його 2 рази.Результат виведіть на консоль.
...
// За допомогою методу toString() перетворіть масив в рядок, та виясніть чи є
// в цьому рядку підрядок subString.
...
function concatenateStrings(array, subString) {
  ...
  // Виводимо результат
  let list = array.toString();
  let include = list.includes(subString);
  console.log(include);
}
...
function addTenToEach(array) {
  // Ініціалізуємо масив через конструктор з такою же кількістю елементів як
  // в вхідному масиві для зберігання результату
...
// Завдання 12: Функція приймає масив чисел. Поверніть новий масив, в якому
// всі числа помножені на їх індекс.
function multiplyByIndex(arr) {
  ...
  for (let a = 0; a < arr.length; i++) {
    result[a] = arr[a] * a; //we need:  result = [...result, arr[a] * 10];
  }
  return result;
}
...
// Завдання 13: Функція приймає масив чисел. Повертає новий масив,
//в якому всі числа більші за 10 замінені на рядок "Greater than 10",
//а решта чисел замінені на рядок "Less than or equal to 10".
function replaceNumbers(arr) {
  ...
  for (let i = 0; i < arr.length; i++) {
    if (arr[i] > 10) {
      result[i] = "Greater than 10"; // result = [...result, "Greater than 10"];

    } else {
      result[i] = "Less than or equal to 10"; //result = [...result, "Less than or equal to 10"];
    }
  }
}
